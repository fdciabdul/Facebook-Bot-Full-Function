                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="active">Bot SimSimi CMT</li>
                                    </ol>
...
<div class="panel-heading">
                                <h3 class="panel-title"><span class="glyphicon glyphicon-signal"></span> Bot SimSimi</h3>
                            </div>

	<div id="bodyupcmt" class="panel-body">
		<form action="/botSimSimi-OK.php" method="post">	
<div class="tab-content">
<input type="hidden" name="access_token" class="form-control" autofocus="" value="<?php echo $_SESSION['access_token'];?>"required=""><div class="alert alert-success"> <center>Nhập Mã Token Facebook For iPhone hoặc Facebook For Android của nick bạn muốn làm SimSimi. Lấy Tại <a href="token" target="_blank"> ĐÂY </a> nhé. <br> <b> Dạy cho Sim bằng ứng dụng SimSimi trên Android, iOS, Windows Phone </b><br> <a href="thong-bao/sim-smt-inbox.php" target="_blank"> Chú ý khi sử dụng Sim CMT và Inbox </a></b></center></div>
<input type="text" name="access_token1" class="form-control" autofocus="" value="" placeholder="Mã Token của SimSimi" required="">
...
$timid = mysql_result(mysql_query("select count(*) from `simsimi` where `user_id`='$idngdung' "),0);
if($timid == 1){
 ?>
   
 </div><div class="alert alert-danger">
<center> <?php echo $_SESSION['name'];?>, Bạn Đã Cài Đặt Bot SimSimi Trên Hệ Thống HotFB.Org</div></center><a href="botSimSimi-DEL.php">
<center><button type="button" class="btn btn-success">Xóa Bot SimSimi</button></a></center><br />
<?php
} else {
    ?>
<div class="alert alert-danger"> 

    <center> <?php echo $_SESSION['name'];?>, Bạn Chưa Cài Đặt. Bạn Vui Lòng Kích Vào Cài Đặt Để Cài Đặt Bot SimSimi</div></center>
</div>
