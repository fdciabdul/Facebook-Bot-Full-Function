...
$dg = json_decode(auto('https://graph.beta.facebook.com/me/likes?access_token='.$access_token.'&method=GET&limit='.$soluong.''),true);
...
mbalek('/DuySexy.php?Lady=AutoPostPage&i='.urlencode('Auto Post Page Thành Công !!!'));
