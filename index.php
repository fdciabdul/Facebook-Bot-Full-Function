		...
		<div class="col-md-6">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
						<b><font color="red"><a href="//thegioisex.cf" target="_blank" rel="dofollow">Hệ thống HotFB.Org với các tính năng Auto Bot độc quyền !</a> </font></b><hr>
						<b><font color="red">Tối nay sẽ gửi curl cho các bạn đã quảng cáo HotFB nhé, tiếp tục QC và inbox cho AD nhận curl !</font></b><hr>
						<b><font color="red">Giới thiệu HotFB.Org để tăng số lượng Like, Sub, Share, Cmt, Acmr Xúc..</font></b>
					</div>
				</div>
			</div>
