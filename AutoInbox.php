...
<div class="content-page">
                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="active">Auto Gửi Tin Nhắn</li>
                                    </ol>
	...
	<div id="bodyupcmt" class="panel-body">
		<form action="/AutoInbox-OK.php" method="post">	
<div class="tab-content"><div class="alert alert-success"> <center>  Auto Gửi Hàng Loạt Tin Nhắn </center></div>
...
<span class="input-group-addon"><span class="glyphicon glyphicon-comment"></span></span><textarea rows="5" type="text" name="noidung" class="form-control" value="" placeholder="" autofocus="" required=""></textarea>
...
<div id="thongbao" style="display: none;"><div class="alert alert-danger">Trạng Thái: <span class="glyphicon glyphicon-refresh gly-animate"></span>  Đang Gửi Tin Nhắn...!
</font></div>
