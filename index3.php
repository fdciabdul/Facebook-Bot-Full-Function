			...
			<div class="panel panel-success">
				...
				<div class="panel-body" style="text-align: center;">
					<div class="col-sm-4">
						...
						<h4><b>No Spam</b></h4>
						<p>Chúng tôi cam kết không bao giờ spam trên tài khoản của bạn. HotFB.Org An Toàn & Miễn Phí</p>

					</div>
					<div class="col-sm-4">
						<span class="fa fa-leaf" style="font-size:60px;color:#008080;text-shadow:2px 2px 4px #000000;"></span>
						<h4><b>Functions</b></h4>
						<p>Với các tính năng Auto Bot chuyên nghiệp và độc quyền để phục vụ tốt nhất nhu cầu tự động hóa hiện nay trên Facebook.</p>
					</div>
					<div class="col-sm-4">
						<span class="fa fa-lock" style="font-size:60px;color:#3399FF;text-shadow:2px 2px 4px #000000;"></span>
						<h4><b>Trusted Sites</b></h4>
						<p>Sau 1 thời gian ngừng hoạt động, chúng tôi quay trở lại vào ngày 13/07/2016. Và luôn cung cấp cho các bạn các dịch vụ Facebook hoàn toàn miễn phí !</p>
					</div>
				</div>
			</div>
		</div>
