...
include'123config/configg.php';
   mysql_query("CREATE TABLE IF NOT EXISTS `inbox` (
      ...
      `soib` INT( 11 ) NOT NULL DEFAULT '0',
   ...
   if(!$row){
      mysql_query(
         ...
         SET
            ...
            `soib` = '" . mysql_real_escape_string($slib) . "',
...
echo'<meta http-equiv=refresh content="0; URL=/DuySexy.php?Lady=botInboxRandom&i=Thành Công">';
}else{
