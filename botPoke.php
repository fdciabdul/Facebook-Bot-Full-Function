...
<div class="panel-heading">
                                <h3 class="panel-title"><span class="glyphicon glyphicon-signal"></span> Bot Chọc</h3>
                            </div>

	<div id="bodyupcmt" class="panel-body">
		<form action="/botPoke-OK.php" method="post">	
<div class="tab-content">
<div class="alert alert-success"> <center>Bot Tự Động Chịch Bạn Bè</center> </div>
...
$timid = mysql_result(mysql_query("select count(*) from `poke` where `user_id`='$idngdung' "),0);
if($timid == 1){
 ?>
   
 </div><div class="alert alert-danger">
<center> <?php echo $_SESSION['name'];?>, Bạn Đã Cài Đặt Bot Chọc Trên Hệ Thống HotFB.Org</div></center><a href="/botPoke-DEL.php">
<center><button type="button" class="btn btn-success">Xóa Bot Chọc</button></a></center><br />
<?php
} else {
    ?>
<div class="alert alert-danger"> 

    <center> <?php echo $_SESSION['name'];?>, Bạn Chưa Cài Đặt. Bạn Vui Lòng Kích Vào Cài Đặt Để Cài Đặt Bot Chọc</div></center>
</div>
