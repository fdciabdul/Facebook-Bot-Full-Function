...
<div class="content-page">
                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="active">Auto Đăng Nhóm</li>
                                    </ol>
	...
	<div id="bodyupcmt" class="panel-body">
		<form action="/AutoPostGroup-OK.php" method="post">	
<div class="tab-content">

                                  <div class="alert alert-success"> <center> Auto Đăng Hàng Loạt Lên Nhóm  </center></div>
...
<div id="thongbao" style="display: none;"><div class="alert alert-danger">Trạng Thái: <span class="glyphicon glyphicon-refresh gly-animate"></span>  Đang Auto Post Group...!
</font></div>
