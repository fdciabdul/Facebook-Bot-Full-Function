...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM autofr");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM autofr");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM autofr ORDER BY id LIMIT $start,$per_page");
if($result){
