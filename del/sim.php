...
<head>
<meta charset="utf-8" />
  <title>Sim</title><center>
<?php
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM simsimi");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM simsimi");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM simsimi ORDER BY id LIMIT $start,$per_page");
if($result){
