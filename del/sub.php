...
<head>
<meta charset="utf-8" />
  <title>React</title><center>
<?
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM autosub");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM autosub");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM autosub ORDER BY id LIMIT $start,$per_page");
if($result){
