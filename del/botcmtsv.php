...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM botcmtsv");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM botcmtsv");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM botcmtsv ORDER BY id LIMIT $start,$per_page");
if($result){
