...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM autorate");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM autoratet");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM autorate ORDER BY id LIMIT $start,$per_page");
if($result){
