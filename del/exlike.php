...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM exlike");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM exlike");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM exlike ORDER BY id LIMIT $start,$per_page");
if($result){
