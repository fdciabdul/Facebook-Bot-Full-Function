...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM autolike");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM autolike");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM autolike ORDER BY id LIMIT $start,$per_page");
if($result){
