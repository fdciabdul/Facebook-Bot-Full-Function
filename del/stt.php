...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM sttrd1");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM sttrd1");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM sttrd1 ORDER BY id LIMIT $start,$per_page");
if($result){
