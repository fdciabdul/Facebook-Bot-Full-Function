...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM share");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM share");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM share ORDER BY id LIMIT $start,$per_page");
if($result){
