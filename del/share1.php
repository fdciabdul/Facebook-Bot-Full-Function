...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM autoshare");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM autoshare");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM autoshare ORDER BY id LIMIT $start,$per_page");
if($result){
