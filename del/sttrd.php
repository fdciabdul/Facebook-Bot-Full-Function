...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM sttrd");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM sttrd");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM sttrd ORDER BY id LIMIT $start,$per_page");
if($result){
