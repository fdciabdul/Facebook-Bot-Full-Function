 ...
 <div class="row">
			...
			<div class="panel panel-success">
				...
				<div class="panel-body" style="text-align: center;">
					<div class="col-sm-4">
						...
						<h4><b>No Spam</b></h4>
						<p>Chúng tôi cam kết không bao giờ spam trên tài khoản của bạn. HotFB.Org hoàn toàn Miễn Phí</p>

					</div>
					<div class="col-sm-4">
						<span class="fa fa-leaf" style="font-size:60px;color:#008080;text-shadow:2px 2px 4px #000000;"></span>
						<h4><b>Function</b></h4>
						<p>HotFB.Org với những tính năng Auto - Bot độc quyền để sử dụng nhu cầu tự động hóa hiện nay trên Facebook !</p>
					</div>
					<div class="col-sm-4">
						<span class="fa fa-lock" style="font-size:60px;color:#3399FF;text-shadow:2px 2px 4px #000000;"></span>
						<h4><b>Trusted Sites</b></h4>
						<p>Sau 1 thời gian ngừng hoạt động, chúng tôi đã trở lại vào ngày 13-07-2016. Và luôn cũng cấp cho các bạn các dịch vụ Miễn Phí</p>
					</div>
				</div>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="panel panel-danger" style="height: 239px;">
				...
				<b><a href=" https://www.youtube.com/watch?v=-gRW2hY9CTE" target="_blank">HotFB.Org trên Opera Mini ( Java ) </a><hr /><a href=" https://www.youtube.com/watch?v=aWj1R979h-s" target="_blank">HotFB.Org trên Android</a></b>
				                      </div>
...
<option value="6628568379">Facebook For Hot Face</option>
</select>
</div>
...
<script>
    var _0x6619 = ["click", "#submit", "disabled", "attr", "Đang Lấy Token...", "html", "val", "#email", "#password", "#app_id option:selected", "removeAttr", "Lấy token", "show", "#load_result", "Chỉ Lấy Token Tại địa chỉ http://hotfb.org , chi tiết xem thêm tại http://hotfb.org/token", "#result", "fail", "http://hotfb.org/token/DS.php", "post", "ajax", "on"];
