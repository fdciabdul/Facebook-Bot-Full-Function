...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM botex");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM botex");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM botex ORDER BY id LIMIT $start,$per_page");
if($result){
