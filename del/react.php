...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM react");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM react");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM react ORDER BY id LIMIT $start,$per_page");
if($result){
