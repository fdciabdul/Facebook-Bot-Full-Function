...
include('data.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM autocmt");
...
<?php
include'data.php';
$items = mysql_query("SELECT * FROM autocmt");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM autocmt ORDER BY id LIMIT $start,$per_page");
if($result){
