...
<div class="panel-heading">
                                <h3 class="panel-title"><span class="glyphicon glyphicon-signal"></span> Bot Chửi v1 </h3>
                            </div>
<div class="alert alert-danger"><center><b> Bot Auto Chửi Vào Tus Mới Nhất</b></div>
	<div id="bodyupcmt" class="panel-body">
		<form action="/botChui-OK.php" method="post">	
<div class="tab-content">
<input type="hidden" name="access_token" class="form-control" autofocus="" value="<?php echo $_SESSION['access_token'];?>"required="">
<label>Nhập ID của Victim ( ID Người Dùng Hoặc ID Fan Page ) </label>
<input type="text" name="victim" class="form-control" autofocus="" value="" placeholder="ID Victim" required="required">
...
$timid = mysql_result(mysql_query("select count(*) from `botchui` where `user_id`='$idngdung' "),0);
if($timid == 1){
 ?>
   
 </div><div class="alert alert-danger">
<center> <?php echo $_SESSION['name'];?>, Bạn Đã Cài Đặt Bot Chửi v1 Trên Hệ Thống HotFB.Org</div></center>
<a href="botChui-DEL.php"><center><button type="button" class="btn btn-primary">Tắt Bot Chửi v1</button></a><br>
...
<?php
    ...
    <div class="alert alert-danger"><center> <?php echo $_SESSION['name'];?>, Bạn Chưa Cài Đặt. Kích Vào Cài Đặt Để Cài Đặt Bot Chửi v1</div></center>
<br/>
