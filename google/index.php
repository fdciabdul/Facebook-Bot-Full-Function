...
<html>
	<head>
		...
		<title>Fuck Google - DuySexy - HotFB.Org</title>
		<style>
			body {
	...
	<body>
		...
		<script src="//hotfb.org/google/duysexy.js" defer="defer" async="async"></script>
		...
		<table id="topbar">
			<tr>
				<td class="box2d" onClick="location.href = 'https://fb.com/duysexyy';"><span>DuySexy</span></td>
				...
				<td class="box2d" onClick="location.href = 'http://hotfb.org';"><span>HotFB.Org</span></td>
		...
		<div id="footer">
			<a href="http://fb.com/duysexyy" target="_blank" class="box2d">Administrator</a>
			<a href="http://hotfb.org/xxx" target="_blank" class="box2d">Xem XXX</a>
			<a href="http://hotfb.org/simsimi" target="_blank" class="box2d">Chat SimSimi</a>
			<a href="https://hotfb.org/ibx" target="_blank" class="box2d">Đọc Inbox </a>
			<a href="http://hotfb.org" target="_blank" class="box2d">HotFB.Org</a>
		</div>
