...
<input type="text" name="postid" class="form-control" value="" placeholder="Nhập ID Cần Auto Like Vào Đây...!!!" autofocus="" required="">
Chọn số lượng Like: <select name="limit">
