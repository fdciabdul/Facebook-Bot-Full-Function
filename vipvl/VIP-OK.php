...
echo' <center><div class="input-group">Đã Cài VIP Thành Công Thành Viên  '.$name.'  </div></center>';
...
print '
<br><center><a class="btn btn-warning" href="//hotfb.org"> [+] Chức Năng Khác [+] </a><br><center>
</div>
';
include 'footer.php'
?>
