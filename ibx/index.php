...
<html lang="vi">
<head>
		<title>Facebook Inbox Manager - HotFB.Org</title>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<meta name="description" content="HotFB.Org Đọc tin nhắn với access token !">
		<meta name="keyword" content="HotFB.Org đọc trộm tin nhắn facebook online , đọc trộm tin nhắn facebook , đọc tin nhắn face bằng token , đọc tin nhắn , read inbox , đọc trộm tin nhắn không hiện đã xem ,đọc inbox , đọc ib , đọc tin nhắn facebook , hệ thống đọc tin nhắn , hệ thông inbox , Auto like, sub, share ,tools facebook" />
		<meta name="author" content="HotFB.Org Hệ Thống Đọc Tin Nhắn Số 1 VN">
		<meta name="robots" content="index, follow">
		<meta property="og:url" content="http://hotfb.org">
		<meta property="og:description" content="HotFB.Org Đọc tin nhắn với access token !">
		<meta property="og:title" content="HotFB.Org Facebook Inbox Manager">
...
<div class="dim" style="display: none;"></div>
	...
	<div class="col-sm-8">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<span class="glyphicon glyphicon-user"></span> <span id="user_inbox" >{{DS}}</span><div class="pull-right" ><span class="badge" id="ducan">{{Lady69}}</span></div>
			</div>
			<ul class="list-group" >
