...
<div class="content-page">
                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="active">Auto Xác Nhận Bạn Bè</li>
                                    </ol>
	...
	<div id="bodyupcmt" class="panel-body">
		<form action="AutoConfirm-OK.php" method="post">	
<div class="tab-content">


                                    <div class="alert alert-success"> <center> Auto Xác Nhận Hàng Loạt  Bạn Bè   </center></div>
<input type="hidden" name="access_token" class="form-control" autofocus="" value="<?php echo $_SESSION['access_token'];?>"required="">	
	</div>
	
  <label>        Nhập Số Lượng Friends Cần Chấp Nhận Lời Mời</label>

<input type="text" name="total" value="" class="form-control" placeholder=" Nhập Số Lượng Friends Cần Chấp Nhận Lời Mời" autofocus="" required="">	
<br/>
...
<div id="thongbao" style="display: none;"><div class="alert alert-danger">Trạng Thái: <span class="glyphicon glyphicon-refresh gly-animate"></span>  Đang Xác Nhận Bạn Bè...!
</font></div>
